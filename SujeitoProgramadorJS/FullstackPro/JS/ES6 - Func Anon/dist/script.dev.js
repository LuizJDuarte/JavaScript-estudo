...
subtrair(20, 40); //subtrair(parseInt(prompt("Digite o número 1:")),parseInt(prompt("Digite o número 2:")));

var lista = [2, 3, 4, 5, 14, 19];
lista.map(function (item) {
  if (item === 14) {
    //Exemplo de implementação com array function e map
    console.log(item);
  }
});